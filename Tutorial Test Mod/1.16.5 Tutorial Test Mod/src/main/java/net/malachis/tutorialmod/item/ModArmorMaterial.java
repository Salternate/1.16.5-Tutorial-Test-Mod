...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    VOID_DIAMOND("void_diamond", 35, new int[] { 3, 6, 7, 4 }, 17, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.7f, 0.0f, () -> { return Ingredient.fromItems(ModItems.VOID_DIAMOND.get()); }),
    //SINGULARITY("void_diamond", 35, new int[] { 7, 7, 7, 7 }, 17, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.7f, 0.0f, () -> { return Ingredient.fromItems(ModItems.VOID_DIAMOND.get()); })
    ;
