...
import net.malachis.tutorialmod.world.gen.ModStructureGeneration;
...
public class ModWorldEvents {
    ...
    public static void addDimensionalSpacing(final WorldEvent.Load event)
    {
        if(event.getWorld() instanceof ServerWorld)
        {
            ...
            tempMap.putIfAbsent(ModStructures.VoidOverworldTop.get(),
                    DimensionStructuresSettings.field_236191_b_.get(ModStructures.VoidOverworldTop.get()));
