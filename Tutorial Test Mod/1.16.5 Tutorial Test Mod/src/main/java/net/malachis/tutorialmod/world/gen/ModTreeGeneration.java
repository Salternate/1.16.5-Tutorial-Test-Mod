...
public class ModTreeGeneration {
    ...
    public static void generateTrees(final BiomeLoadingEvent event)
    {
        ...
        if(types.contains(BiomeDictionary.Type.PLAINS))
        {
            ...
            base.add(() -> ModConfiguredFeatures.VOID.withPlacement(Features.Placements.HEIGHTMAP_PLACEMENT).withPlacement(Placement.COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig(1, 0.77f, 2))));
        }
    }
}
