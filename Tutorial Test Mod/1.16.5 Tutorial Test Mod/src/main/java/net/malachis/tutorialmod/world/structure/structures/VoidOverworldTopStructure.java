package net.malachis.tutorialmod.world.structure.structures;
...
public class VoidOverworldTopStructure extends Structure<NoFeatureConfig> {
    public VoidOverworldTopStructure() {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return VoidOverworldTopStructure.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(TutorialMod.MOD_ID, "void_overworld_top/start_pool")),
